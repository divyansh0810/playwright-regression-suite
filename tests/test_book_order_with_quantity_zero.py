#Booking an order with quantity 0 and verifying a popup message
...
def test_book_order_with_quantity_zero():
    with sync_playwright() as p:
        ...
        print("Entering the quantity to 0")
        
        page.get_by_role("textbox", name="Qty").click()
        page.get_by_role("textbox", name="Qty").fill("0")
        ...
        print("Zero quantity pop-up verified successfully.")
