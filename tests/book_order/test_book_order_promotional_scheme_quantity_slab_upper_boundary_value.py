...
#and verifying the correct rate changes with correct quantity slab upper value.
...
def test_book_order_promotional_scheme_quantity_slab_upper_boundary_value():
    with sync_playwright() as p:
        ...
        page.get_by_role("textbox", name="Qty").fill("499")
        ...
        page.get_by_role("textbox", name="Qty").click()
        page.get_by_role("textbox", name="Qty").fill("999")
        page.get_by_role("textbox", name="Qty").press("Enter")
        ...
        page.get_by_role("textbox", name="Qty").click()
        page.get_by_role("textbox", name="Qty").fill("2000")
        page.get_by_role("textbox", name="Qty").press("Enter")
        ...
        print("Promotional scheme slab price for upper boundary verified successfully.")
