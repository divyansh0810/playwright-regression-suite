...
#and verifying the correct rate changes with correct quantity slab inner value.
...
def test_book_order_promotional_scheme_quantity_slab_inner_value():
    with sync_playwright() as p:
        ...
        page.get_by_role("textbox", name="Qty").fill("300")
        ...
        page.get_by_role("textbox", name="Qty").click()
        page.get_by_role("textbox", name="Qty").fill("700")
        page.get_by_role("textbox", name="Qty").press("Enter")
        ...
        page.get_by_role("textbox", name="Qty").click()
        page.get_by_role("textbox", name="Qty").fill("1200")
        page.get_by_role("textbox", name="Qty").press("Enter")
        ...
        print("Promotional scheme slab price for inner values verified successfully.")
